...
Security fixes are provided for **currently supported release lines** of `switon/session` (`switon/session` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/session/security/advisories/new)
